    ...
    return (
        <div className="flex flex-col gap-5">
            <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-(--btn-activo-sidebar) hover:opacity-90 transition cursor-pointer text-white text-sm font-medium">
