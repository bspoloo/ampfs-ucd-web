...
export default function FormTeam({ club, isOpen, onClose, onSaved }: FormTeamProps) {
        ...
        try {
            ...
            await postData<object, object>(
                { endpoint: "teams", accessToken: session!.accessToken },
                {
                    ...
                    uniformColor: formData.uniformColor,
                    clubId: club.id,
                }
            )
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-(--bg-sidebar) border border-(--border-dark) rounded-2xl shadow-2xl z-10 overflow-hidden w-[90%] max-w-[480px]">
                {/* Header */}
